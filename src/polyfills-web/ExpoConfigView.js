...
import { SectionList, Image, Platform, StyleSheet, Text, View } from 'react-native';
let Constants = (Platform.OS !== 'web') && require('expo-constants').Constants;
if (!Constants) {
  Constants = require('./ExpoConstants').default;
}
